...
class TestSlider:
    ...
    def test_slider_current_value(self, slider):
        ...
        assert (slider.get_slider_value() ==
                TestData.slider_default_value), "Incorrect initial slider value."

    @pytest.mark.parametrize(
        "method, expected", [("get_slider_min_value", TestData.slider_min_value),
                             ("get_slider_max_value", TestData.slider_max_value),])
    ...
    def test_set_slider_max_value(self, slider):
        ...
        slider.set_slider_value(TestData.slider_max_value)
        assert (slider.get_slider_value() ==
                TestData.slider_max_value), f"Failed to set max value {TestData.slider_max_value}."
    ...
    def test_set_exceed_max(self, slider):
        ...
        assert (slider.get_slider_value() ==
                TestData.slider_max_value), f"Maximum value expected: {TestData.slider_max_value}."

    def test_set_slider_min_value(self, slider):
        """Verify the new set slider Min value."""
        slider.set_slider_value(TestData.slider_min_value)
        assert (slider.get_slider_value() ==
                TestData.slider_min_value), f"Failed to set Min value {TestData.slider_min_value}."
    ...
    def test_set_negative_value(self, slider):
        ...
        slider.set_slider_value(new_val)
        assert (slider.get_slider_value() ==
                TestData.slider_min_value), f"Minimum value expected: {TestData.slider_min_value}."